...
export function LivingKnowledgeHero() {
  ...
  return <KnowledgeScene className="absolute inset-0 opacity-90" onNodeSelect={handleSelect} focusId={selectedNodeId} selectedIds={selectedNodeId ? [selectedNodeId] : []} />;
}
